                      ...
                      <div className="info-tabs flex flex-wrap gap-4 mb-12">
                        ...
                        >
                          <Button
                            ...
                            style={{
                              color:
                                showInfo === 0 ? "var(--btnblue) " : "#000",
                              fontWeight: showInfo === 0 ? "700" : "normal",
                              borderBottom:
                                showInfo === 0
                                  ? "1px solid var(--btnblue) "
                                  : "none",
                            }}
                          >
                            Description
                        ...
                        >
                          <Button
                            style={{
                              color:
                                showInfo === 1 ? "var(--btnblue) " : "#000",
                              fontWeight: showInfo === 1 ? "700" : "normal",
                              borderBottom:
                                showInfo === 1
                                  ? "1px solid var(--btnblue) "
                                  : "none",
                        ...
                        >
                          <Button
                            style={{
                              color:
                                showInfo === 2 ? "var(--btnblue) " : "#000",
                              fontWeight: showInfo === 2 ? "700" : "normal",
                              borderBottom:
                                showInfo === 2
                                  ? "1px solid var(--btnblue) "
                                  : "none",
